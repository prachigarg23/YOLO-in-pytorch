...
#the class file such as coco.names contains the names of the classes for our detector
#loading the class file in our program
num_classes = 80
...
# if destination directory doesn't exist, we make one
...
"""
PROCEED TO DRAW BOUNDING boxes
"""
# we check if a single detection has been made or not
try:
    output
except NameError:
